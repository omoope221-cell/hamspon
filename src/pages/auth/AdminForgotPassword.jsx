      ...
      <div className="w-full max-w-sm">
        ...
        {step === STEPS.EMAIL && (
          <form onSubmit={handleRequestCode} className="space-y-4">
            <p className="text-sm text-gray-500 text-center -mt-2 mb-2">
              Enter your registered Admin email address and we'll send you a verification code.
            </p>
            <Field label="Email Address">
              <Input
                ...
                placeholder="admin@hampsonsgroupofschools.edu.ng"
              />
            </Field>
        ...
        {step === STEPS.DONE && (
          <div className="text-center space-y-4">
            ...
            <Button variant="brass" className="w-full" onClick={() => navigate('/admin/login', { replace: true })}>
              Go to Admin Login
            </Button>
          </div>
        )}
